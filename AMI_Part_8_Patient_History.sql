...
/*
Update 5/8 2020
Replace obj names to match Dartmouth OMOP
...
IF OBJECT_ID('#Table1_Patient_History1', 'U') IS NOT NULL 
BEGIN
  DROP TABLE #Table1_Patient_History1
END
GO
...
--Combine temp tables-----------------------------------------------------------------
 ...
 IF OBJECT_ID('Table1_Patient_History', 'U') IS NOT NULL 
BEGIN
