...
--Age >= 80-----------------------------------------------------------------------------
--drop table if exists #Table1_Comorbidities_Age_80_Flag

if exists (select * from sys.objects where name = '#Table1_Comorbidities_Age_80_Flag' and type = 'u')
    drop table #Table1_Comorbidities_Age_80_Flag
...
--Conditions-----------------------------------------------------------------------------
--drop table if exists #Table1_Comorbidities1

if exists (select * from sys.objects where name = '#Table1_Comorbidities1' and type = 'u')
    drop table #Table1_Comorbidities1
...
--drop table if exists #Table1_Comorbidities_CD

if exists (select * from sys.objects where name = '#Table1_Comorbidities_CD' and type = 'u')
    drop table #Table1_Comorbidities_CD
;
...
--drop table if exists #Table1_Comorbidities2

if exists (select * from sys.objects where name = '#Table1_Comorbidities2' and type = 'u')
    drop table #Table1_Comorbidities2
...
--Prior revascularization--------------------------------------------------------------------------------
--drop table if exists #Table1_Comorbidities_Prior_Revascularization_Flag

if exists (select * from sys.objects where name = '#Table1_Comorbidities_Prior_Revascularization_Flag' and type = 'u')
    drop table #Table1_Comorbidities_Prior_Revascularization_Flag
;
...
--Combine temp tables-----------------------------------------------------------------
--drop table if exists #Table1_Comorbidities_Part_1

if exists (select * from sys.objects where name = '#Table1_Comorbidities_Part_1' and type = 'u')
    drop table #Table1_Comorbidities_Part_1
;
...
AIDS								6		
*/
--drop table if exists #Table1_Comorbidities_Part_2


if exists (select * from sys.objects where name = '#Table1_Comorbidities_Part_2' and type = 'u')
    drop table #Table1_Comorbidities_Part_2
;
...
if exists (select * from sys.objects where name = 'Table1_Comorbidities' and type = 'u')
