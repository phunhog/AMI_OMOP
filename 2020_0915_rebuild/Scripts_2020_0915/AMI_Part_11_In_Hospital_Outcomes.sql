...
----drop table if exists #Table1_In_Hospital_Outcomes_HF_Stroke;
...
;
 ...
 --echocardiography
----drop table if exists #Table1_In_Hospital_Outcomes_Echo;
...
----drop table if exists #Table1_HOSPITAL_Outcomes_Cardiac_Procedure;
...
--select Cardiac_Procedure_Flag, count(*) from Table1_HOSPITAL_Outcomes_Cardiac_Procedure group by Cardiac_Procedure_Flag;
 ...
 --drop table if exists Table1_In_Hospital_Outcomes;

 if exists (select * from sys.objects where name = 'Table1_In_Hospital_Outcomes' and type = 'u')
